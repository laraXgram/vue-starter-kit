        ...
        <div class="wrap">
            <div class="topbar">
                ...
                <div class="chips">
                    ...
                    <span class="chip">v<b>{{ version ?? '4.x' }}</b></span>
                    <span class="chip">PHP <b>{{ phpVersion ?? '8.x' }}</b></span>
                </div>
            </div>
            ...
            <footer>
                <div class="foot">
                    <span>© {{ new Date().getFullYear() }} LaraGram <span class="dot">·</span> The LaraGram framework</span>
                    <span>
                        <a href="https://github.com/laraxgram" target="_blank" rel="noopener">github.com/laraxgram</a>
                        <span class="dot">·</span> LARAGRAM v{{ version ?? '4.x' }}
                    </span>
                </div>
            </footer>
        </div>
...
.lg-page * { box-sizing: border-box; margin: 0; padding: 0; }
.lg-page {
...
footer { position: relative; z-index: 1; border-top: 1px solid var(--line-soft); margin-top: auto; }
